<template>
    <div class="afanti">
        ...
        <div class="admin_table_handle_btn">
            <a-button @click="$router.push('/Admin/seckills/form')" type="primary" icon="plus">添加</a-button>
        ...
        <div class="admin_table_list">
            <a-table :columns="columns" :data-source="list" :pagination="false" :row-selection="{ selectedRowKeys: selectedRowKeys, onChange: onSelectChange }" row-key="id">
                ...
                <span slot="action" slot-scope="rows">
                    <a-button icon="edit" @click="$router.push('/Admin/seckills/form/'+rows.id)">编辑</a-button>
                </span>
            </a-table>
...
export default {
    ...
    methods: {
        ...
        del(){
            ...
            this.$confirm({
                ...
                onOk:()=> {
                    ...
                    this.$delete(this.$api.adminSeckills+'/'+ids).then(res=>{
                        if(res.code == 200){
                            this.onload();
        ...
        onload(){
            this.$get(this.$api.adminSeckills,this.params).then(res=>{

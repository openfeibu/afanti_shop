    ...
    export default {
        ...
        methods: {
            ...
            wechat_login(){
                ...
                window.open('http://afanti.feibu.info/api/oauth/callback/weixinweb', 'newwindow', 'height=500, width=500, top=0, left=0, toolbar=no, menubar=no, scrollbars=no, resizable=no,location=n o, status=no')

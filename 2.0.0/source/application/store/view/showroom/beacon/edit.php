                    ...
                    <div class="widget-body">
                        <fieldset>
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">编辑蓝牙信标</div>
                            </div>
                                        ...
                                        <?php if (isset($showroomList) && !$showroomList->isEmpty()):
                                            foreach ($showroomList as $item): ?>
                                                <option value="<?= $item['showroom_id'] ?>"
                                                    <?= $model['beacon_showroom']['showroom_id'] == $item['showroom_id'] ? 'selected' : '' ?> >
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="beacon[major_id]"
                                           placeholder="请输入Major ID" value="<?= $model['major_id'] ?>" required>
                                </div>
                            </div>

                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="showroom[showroom_name]"
                                           placeholder="请输入展馆名称" value="<?= $model['showroom_name'] ?>" required>
                                </div>
                            </div>
                            <div class="am-form-group am-padding-top">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <textarea class="am-field-valid" rows="5" placeholder="请输入展馆简介"
                                              name="showroom[description]"><?= $model['description'] ?></textarea>
                                </div>
                            </div>
                                        ...
                                        <div class="am-form-file">
                                            ...
                                            <div class="uploader-list uploader-list-face am-cf">
                                                <div class="file-item face-item">
                                                    <a href="<?= $model['face_image']['file_path'] ?>"
                                                       title="点击查看大图" target="_blank">
                                                        <img src="<?= $model['face_image']['file_path'] ?>">
                                                    </a>
                                                    <input type="hidden" name="showroom[face_image_id]"
                                                           value="<?= $model['face_image_id'] ?>">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <div class="am-form-file">
                                        ...
                                        <div class="uploader-list uploader-list-slide am-cf">
                                            <?php foreach ($model['slide'] as $key => $item): ?>
                                                <div class="file-item slide-item">
                                                    <a href="<?= $item['file_path'] ?>" title="点击查看大图" target="_blank">
                                                        <img src="<?= $item['file_path'] ?>">
                                                    </a>
                                                    <input type="hidden" name="showroom[slides][]"
                                                           value="<?= $item['image_id'] ?>">
                                                    <i class="iconfont icon-shanchu file-item-delete slide-item-delete"></i>
                                                </div>
                                            <?php endforeach; ?>
                                        </div>
                                    </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="showroom[monitoring_channel]"
                                           placeholder="请输入展馆监控频道号" value="<?= $model['monitoring_channel'] ?>">
                                </div>
                            </div>
                            <div class="am-form-group">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="showroom[is_store]" value="1" data-am-ucheck
                                            <?= $model['is_store'] == 1 ? 'checked' : '' ?>>
                                        是
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="showroom[is_store]" value="0" data-am-ucheck
                                            <?= $model['is_store'] == 0 ? 'checked' : '' ?>>
                                        否
                                    </label>
                                </div>
                            </div>
